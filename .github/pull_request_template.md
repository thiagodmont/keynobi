...
- [ ] New cross-cutting patterns: noted for maintainers in [CONTRIBUTING.md](../CONTRIBUTING.md) / [AGENTS.md](../AGENTS.md) session rules (`references/CODE_PATTERN.md`, `references/DOMAIN_PATTERNS.md`, or `references/BEST_PRACTICES.md` as appropriate)
